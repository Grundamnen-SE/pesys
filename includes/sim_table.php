<table class="tab1 sim_table">
  ...
  <tr>
    ...
    <td class="td-gas gas"><span class="atomic_number ">18</span>Ar</td>
  </tr>
  <tr>
    ...
    <td class="td-fast ove"><span class="atomic_number ">25</span>Mn</td>
    ...
    <td class="td-fast hme"><span class="atomic_number ">33</span>As</td>
    <td class="td-fast ick"><span class="atomic_number ">34</span>Se</td>
    <td class="td-flow hao"><span class="atomic_number ">35</span>Br</td>
    <td class="td-gas gas"><span class="atomic_number ">36</span>Kr</td>
  </tr>
  <tr>
    ...
    <td class="td-fast ove"><span class="atomic_number ">43</span>Tc</td>
    ...
    <td class="td-fast hme"><span class="atomic_number ">51</span>Sb</td>
    <td class="td-fast hme"><span class="atomic_number ">52</span>Te</td>
    <td class="td-gas hao"><span class="atomic_number ">52</span>I</td>
    <td class="td-gas gas"><span class="atomic_number ">54</span>Xe</td>
  </tr>
  <tr>
    <td class="td-fast alk"><span class="atomic_number ">55</span>Cs</td>
    <td class="td-fast jor"><span class="atomic_number ">56</span>Ba</td>
    <td class="td-extend">&gt;</td>
    <td class="td-fast ove"><span class="atomic_number ">72</span>Hf</td>
    <td class="td-fast ove"><span class="atomic_number ">73</span>Ta</td>
    <td class="td-fast ove"><span class="atomic_number ">74</span>W</td>
    <td class="td-fast ove"><span class="atomic_number ">75</span>Re</td>
    <td class="td-fast ove"><span class="atomic_number ">76</span>Os</td>
    <td class="td-fast ove"><span class="atomic_number ">77</span>Ir</td>
    <td class="td-fast ove"><span class="atomic_number ">78</span>Pt</td>
    <td class="td-fast ove"><span class="atomic_number ">79</span>Au</td>
    <td class="td-flow ove"><span class="atomic_number ">80</span>Hg</td>
    <td class="td-fast ovr"><span class="atomic_number ">81</span>Tl</td>
    <td class="td-fast ovr"><span class="atomic_number ">82</span>Pb</td>
    <td class="td-fast ovr"><span class="atomic_number ">83</span>Bi</td>
    <td class="td-fast hme"><span class="atomic_number ">84</span>Po</td>
    <td class="td-fast hao"><span class="atomic_number ">85</span>At</td>
    <td class="td-gas gas"><span class="atomic_number ">86</span>Rn</td>
  </tr>
  <tr>
    <td class="td-fast alk"><span class="atomic_number ">87</span>Fr</td>
    <td class="td-fast jor"><span class="atomic_number ">88</span>Ra</td>
    <td class="td-extend">&gt;&gt;</td>
    <td class="td-fast ove"><span class="atomic_number ">104</span>Rf</td>
    <td class="td-fast ove"><span class="atomic_number ">105</span>Db</td>
    <td class="td-fast ove"><span class="atomic_number ">106</span>Sg</td>
    <td class="td-fast ove"><span class="atomic_number ">107</span>Bh</td>
    <td class="td-fast ove"><span class="atomic_number ">108</span>Hs</td>
    <td class="td-fast eju"><span class="atomic_number ">109</span>Mt</td>
  ...
  <tr>
    <td class="td-extend">&gt;</td>
    <td class="td-fast lan"><span class="atomic_number ">57</span>La</td>
    <td class="td-fast lan"><span class="atomic_number ">58</span>Ce</td>
    <td class="td-fast lan"><span class="atomic_number ">59</span>Pr</td>
    <td class="td-fast lan"><span class="atomic_number ">60</span>Nd</td>
    <td class="td-fast lan"><span class="atomic_number ">61</span>Pm</td>
  ...
  <tr>
    <td class="td-extend">&gt;&gt;</td>
    <td class="td-fast akt"><span class="atomic_number ">89</span>Ac</td>
    <td class="td-fast akt"><span class="atomic_number ">90</span>Th</td>
    <td class="td-fast akt"><span class="atomic_number ">91</span>Pa</td>
    <td class="td-fast akt"><span class="atomic_number ">92</span>U</td>
    <td class="td-fast akt"><span class="atomic_number ">93</span>Np</td>
    <td class="td-fast akt"><span class="atomic_number ">94</span>Pu</td>
    <td class="td-fast akt"><span class="atomic_number ">95</span>Am</td>
    <td class="td-fast akt"><span class="atomic_number ">96</span>Cm</td>
    <td class="td-fast akt"><span class="atomic_number ">97</span>Bk</td>
    <td class="td-fast akt"><span class="atomic_number ">98</span>Cf</td>
    <td class="td-fast akt"><span class="atomic_number ">99</span>Es</td>
    <td class="td-fast akt"><span class="atomic_number ">100</span>Fm</td>
    <td class="td-fast akt"><span class="atomic_number ">101</span>Md</td>
    <td class="td-fast akt"><span class="atomic_number ">102</span>No</td>
    <td class="td-fast akt"><span class="atomic_number ">103</span>Lr</td>
    <td class="td-none"></td>
    <td class="td-none"></td>
  </tr>
</table>
...
<table class="tab2 sim_table">
  ...
  <tr>
    ...
    <td class="td-gas ick"><span class="atomic_number">7</span>N</td>
    <td class="td-gas ick"><span class="atomic_number">8</span>O</td>
    <td class="td-gas hao fluor"><span class="atomic_number">9</span>F</td>
    <td class="td-gas gas"><span class="atomic_number">10</span>Ne</td>
  </tr>
  <tr>
    <td class="td-fast alk"><span class="atomic_number">11</span>Na</td>
  ...
  <tr class="tr-space">
    <td colspan="2" class="td-logo"><a class="webbstj" href="http://webbstjarnan.se" target="_blank"><img title="Webbstjärnan" src="http://www.webbstjarnan.se/wordpress/wp-content/uploads/se_webbstjarnan_ny_vit.png" alt="" width="250" /></a></td>
    <td colspan="14"></td>
    <td colspan="2" class="td-logo"><a class="license" rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/"><img alt="Creative Commons-licens" style="border-width:0" src="https://i.creativecommons.org/l/by-nc-sa/4.0/88x31.png" /></a></td>
  </tr>
  <tr>
    <td class="td-extend">&gt;</td>
    <td class="td-fast lan"><span class="atomic_number ">57</span>La</td>
