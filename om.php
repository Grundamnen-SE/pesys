...
<html lang="sv">
  ...
  <body>
    ...
    <div id="main">
      ...
      <div id="right">
        <h1 id="about-us">Om oss:</h1>
        <img id="us" src="/img/oss.jpg">
      ...
      <div id="left">
        ...
        <p>
          ...
          och glad färgskala för att väcka användarens intresse, vilket är
          grundtanken med hemsidan; att skapa ett modernt periodiskt system som fångar
          besökarens uppmärksamhet. Vi har av denna anledning valt att göra videor om de
          ämnen vi hittar som komplement till text och bilder.<br>
        ...
        <h1>Kontakt</h1>
        <p class="om-bottom">
          Har du synpunkter, frågor eller funderingar? Har du hittat ett fel? Då
          får du jättegärna mejla oss! Adressen är:
        </p>
        <img src="/img/email-dark.png">
        <p>
          Vi finns även på:
